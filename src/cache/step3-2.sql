...
-- -- -- country_codes -- -- --
	 ...
	 CREATE FOREIGN TABLE tmpcsv_country_codes (
	   ...
	   CREATE VIEW dataset.vw_country_codes AS
		SELECT (c->>0)::text AS name, (c->>1)::text AS official_name_en, (c->>2)::text AS official_name_fr, (c->>3)::text AS iso3166_1_alpha_2, (c->>4)::text AS iso3166_1_alpha_3, (c->>5)::float AS m49, (c->>6)::text AS itu, (c->>7)::text AS marc, (c->>8)::text AS wmo, (c->>9)::text AS ds, (c->>10)::text AS dial, (c->>11)::text AS fifa, (c->>12)::text AS fips, (c->>13)::text AS gaul, (c->>14)::text AS ioc, (c->>15)::text AS iso4217_currency_alphabetic_code, (c->>16)::text AS iso4217_currency_country_name, (c->>17)::float AS iso4217_currency_minor_unit, (c->>18)::text AS iso4217_currency_name, (c->>19)::float AS iso4217_currency_numeric_code, (c->>20)::text AS is_independent, (c->>21)::text AS capital, (c->>22)::text AS continent, (c->>23)::text AS tld, (c->>24)::text AS languages, (c->>25)::float AS geoname_id, (c->>26)::text AS edgar
